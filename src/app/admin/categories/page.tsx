    ...
    try {
      await Promise.all([
        ...
        fetch("/api/admin/categories", {
          method: "PATCH",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({ id: targetCategory.id, sortOrder: oldOrder === newOrder ? newOrder + delta : oldOrder }),
        }),
      ]);
      toast.success("Category order updated");
      await loadCategories();
    } catch {
      toast.error("Failed to re-order categories");
    }
  }
